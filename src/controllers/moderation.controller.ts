...
import { ReportPayload, ModerationService } from '../lib/types/moderation';
...
//     const summary = await Promise.all(
//       reports.map(async (report: any, idx: number) => {
//         // Build the payload (overriding performed_by with acting user's DID).
//         const payload = {
//           targetedPostUri: report.targetedPostUri,
//           reason: report.reason,
//           toServices: report.toServices, // Expecting an array of services.
//           targetedUserDid: report.targetedUserDid,
//           uri: report.uri,
//           feedName: report.feedName,
//           additionalInfo: report.additionalInfo || '',
//           action: report.action, // Must be of type ModAction.
...
//         const resultDetails: any[] = [];
//         console.log(`Processing report ${idx}:`, payload);
...
//           )
//         ) {
//           console.log(`Report ${idx}: Blacksky service requested.`);
//           if (blackskyServiceGate()) {
//             console.log(`Report ${idx}: Blacksky service gate passed.`);
//             try {
//               const blackskyResult = await reportToBlacksky([
//                 { uri: payload.targetedPostUri },
//               ]);
//               console.log(`Report ${idx}: Blacksky result:`, blackskyResult);
//               resultDetails.push({
//                 service: 'blacksky',
//                 result: blackskyResult,
//               });
...
//           }
//         } else {
//           console.log(`Report ${idx}: Blacksky service not requested.`);
//         }
